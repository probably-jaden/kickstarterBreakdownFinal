...
def load_data():
    ...
    >>> df = load_data()
    >>> df.head()
       usd_exchange_rate  usd_pledged     category   ...  name  backers_count
    0               1.0         500.0  technology    ...   App           10
    ...
    df_combined = df_combined[['usd_exchange_rate', 'usd_pledged', 'category', 'goal', 
